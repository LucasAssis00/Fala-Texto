...
# 2) INIT APP & RATE-LIMITER
app = FastAPI(title="API FastAPI: PDF, Áudio e Face")
...
# 9) RUN WITH SSL (Uvicorn)
# uvicorn main:app \
#   --host 0.0.0.0 --port 5000 \
#   --ssl-certfile=/caminho/para/server_cert.pem \
#   --ssl-keyfile=/caminho/para/server_key.pem
